    ...
    return (
        <footer className="bg-gray-900 text-gray-200">
            <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
                {/* Logo & About */}
                <div>
                    <h3 className="text-2xl font-bold text-white mb-3">SkillXchangee</h3>
                    <p className="text-gray-400">
                        Empowering individuals to exchange skills, grow together, and build a future of collaboration.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-400">Email: skillxchangee@gmail.com</p>
                    <p className="text-sm text-gray-400">Phone: +91 7008133088</p>
                </div>
            </div>

            <div className="border-t border-gray-800 py-4 text-center text-sm text-gray-500">
                © {new Date().getFullYear()} SkillXchangee. All rights reserved.
            </div>
        </footer>
    );
}